    ...
    return (
        <section className="container relative flex items-center justify-center mt-16">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[20rem] md:h-[36rem items-center">
                <div className="flex flex-col items-center justify-center gap md:items-start lg:items-start">
                    <h1 className="text-gray-100 text-heading-hg">Venda seus produtos como afiliado em um único lugar.</h1>
                </div>

                <div className="flex flex-col ite justi gap-4 md:items-start lg:items-start">
                    <div>
                        <div className="flex items-center gap-2">
                            <Clock className="text-cyan-100 h-4 w-4" />
                            <span className="text-gray-200">Crie seu site em 5 minutos</span>
                        </div>

                        <div className="flex items-center gap-2">
                            <Store className="text-cyan-100 h-4 w-4" />
                            <span className="text-gray-200">Acompanhe e optime seu negócio online</span>
                        </div>
                ...
                <div className="relative h-[20rem] hidden md:h-full order-first md:order-last items-center justify-center md:flex lg:flex">
                    <Image
                        ...
                        alt="Ilustação com ícones de store, tag e sacola"
                        width={200}
                        height={400}
